...
if __name__ == "__main__":
    ...
    try:
        weather_information("Lewisville"+"weather") #Test case for City, output should be: Lewisville, TX Monday 5:00 PM Partly cloudy 77°F
        weather_information("Texas"+"weather") #Test case for State, output should be: Houston, TX Monday 5:00 PM Cloudy 76°F
        weather_information("Ontario"+"weather") #Test case for province, output should be: Toronto, ON, Canada Monday 6:00 PM Cloudy 32°F
        weather_information("United States"+"weather") #Test case for country, output should be: Washington, DC Monday 6:00 PM Cloudy 43°F
